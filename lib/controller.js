...
var getMovie = Promise.promisify(movieDbApi.getMovie.bind(movieDbApi));
	...
	processMessage: function (_message, callback) {
		...
		sendMessageToConversation(message)
			...
			.then(function (messageResponse) {
				...
				// var idx = messageResponse.intents.map(function (x) { return x.intent; }).indexOf('movie');
